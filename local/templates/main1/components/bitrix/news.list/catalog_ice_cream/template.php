			...
			<a class="catalog-card" href="<?=$arItem["DETAIL_PAGE_URL"]?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
				...
				<div class="catalog-card__inner">
					<div class="catalog-card__top">
						...
						<div class="catalog-card__title"><?echo $arItem["NAME"]?></div>
					</div>
					<div class="catalog-card__bot">
						...
						<div class="catalog-card__plugs">
							...
							<div data-text=“<?=$arItem['PROPERTIES']['gram']['HINT']?>” class="catalog-card__plug-info"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
							...
							<div class="catalog-card__plug">
								...
								<div data-text=“<?=$arItem['PROPERTIES']['in_box']['HINT']?>” class="catalog-card__plug-info"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
										<rect x="0.5" y="0.5" width="23" height="23" rx="5.5" fill="white"></rect>
										<path d="M12.75 11C12.75 10.5858 12.4142 10.25 12 10.25C11.5858 10.25 11.25 10.5858 11.25 11V17C11.25 17.4142 11.5858 17.75 12 17.75C12.4142 17.75 12.75 17.4142 12.75 17V11Z" fill="#0068FF"></path>
										<path d="M13 8C13 8.55228 12.5523 9 12 9C11.4477 9 11 8.55228 11 8C11 7.44772 11.4477 7 12 7C12.5523 7 13 7.44772 13 8Z" fill="#0068FF"></path>
										<rect x="0.5" y="0.5" width="23" height="23" rx="5.5" stroke="#CEDFF5"></rect>
							...
							<div class="catalog-card__plug">
								...
								<div class="catalog-card__plug-text"><?=$arItem['PROPERTIES']['in_poddon']['VALUE']?> шт</div>
								<div data-text=“<?=$arItem['PROPERTIES']['in_poddon']['HINT']?>” class="catalog-card__plug-info"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewbox="0 0 24 24" fill="none">
										<rect x="0.5" y="0.5" width="23" height="23" rx="5.5" fill="white"></rect>
										<path d="M12.75 11C12.75 10.5858 12.4142 10.25 12 10.25C11.5858 10.25 11.25 10.5858 11.25 11V17C11.25 17.4142 11.5858 17.75 12 17.75C12.4142 17.75 12.75 17.4142 12.75 17V11Z" fill="#0068FF"></path>
										<path d="M13 8C13 8.55228 12.5523 9 12 9C11.4477 9 11 8.55228 11 8C11 7.44772 11.4477 7 12 7C12.5523 7 13 7.44772 13 8Z" fill="#0068FF"></path>
										<rect x="0.5" y="0.5" width="23" height="23" rx="5.5" stroke="#CEDFF5"></rect>
