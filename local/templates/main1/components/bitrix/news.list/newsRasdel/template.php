	...
	false
        ...
        <div class="news-content__categories" data-aos="fade-up">
            <div class="news-content__categories-wrapper">
                <a class="news-content__categories-item <? if ($arParams['PARENT_SECTION_CODE'] == $item['CODE']) : ?>active<? endif ?> btn-hover_parent no-scale"
                    href="/news/">
        ...
        <div class="news-content__listing" data-aos="fade-up">
            ...
            <a class="news-card" id="<?= $this->GetEditAreaId($arItem['ID']); ?>"
