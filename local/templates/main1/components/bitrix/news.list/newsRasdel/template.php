...
<section class="top-section">
	<section class="news-content container">
		...
		<div class="news-content__categories" data-aos="fade-up">
			...
			<?foreach($arParams['categories'] as $k => $l):?>
				<a class="news-content__categories-item active btn-hover_parent no-scale" href="?catalog=<?=$k?>">
...
<a class="news-card" href="#" id="<?=$this->GetEditAreaId($arItem['ID']);?>" href="<?=$arItem["DETAIL_PAGE_URL"]?>">
    <div class="news-card__top">
        <div class="news-card__plug"><?=$arItem['DETAIL_LIST']['NAME']?></div>
