	...
	<div class="main-catalog__list" data-aos="fade-up" data-aos-duration="1500"><a
			...
			<div class="main-catalog__item-bg desktop">
				<picture class="picture">
					<source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg1.webp"><img
						class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg1.png">
				</picture>
			</div>
			<div class="main-catalog__item-bg mobile">
				<picture class="picture">
					<source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg1-mobile.webp"><img
						class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg1-mobile.png">
				</picture>
			</div>
			...
			<div class="main-catalog__item-svg">
				<div class="button button-arrow_right btn-hover_parent">
					<div class="btn-hover_circle total-white"></div><svg xmlns="http://www.w3.org/2000/svg" width="24"
			...
			<div class="main-catalog__item-bg desktop">
				<picture class="picture">
					<source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg2.webp"><img
						class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg2.png">
				</picture>
			</div>
			<div class="main-catalog__item-bg mobile">
				<picture class="picture">
					<source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg2-mobile.webp"><img
						class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg2-mobile.png">
				</picture>
			</div>
			<div class="main-catalog__item-row">
			...
			<div class="main-catalog__item-bg desktop">
				<picture class="picture">
					<source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg3.webp"><img
						class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg3.png">
				</picture>
			</div>
			<div class="main-catalog__item-bg mobile">
				<picture class="picture">
					<source type="image/webp" srcset="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg3-mobile.webp"><img
						class="picture__img" src="<?php echo SITE_TEMPLATE_PATH ?>/assets/images/main-catalog-item-bg3-mobile.png">
				</picture>
			</div>
			<div class="main-catalog__item-row">
